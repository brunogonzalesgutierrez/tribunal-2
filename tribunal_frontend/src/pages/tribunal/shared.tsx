...
export interface VocalTribunal {
  idVocal: number;
  cargo: string;
...
export interface ExpedienteSimple {
  idExpediente: number;
...
export const InstanciaBadge = ({ instancia }: { instancia: string }) => (
...
export const CargoBadge = ({ cargo }: { cargo: string }) => (
  <span className="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-semibold bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-400">
    {cargo}
  </span>
);
...
export function TablaDesktop({
  headers, children, loading, emptyMsg,
}: {
